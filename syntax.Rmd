...
Variable and function names should only include letters and numbers. Symbols should be avoided.  

Variable names should use small camel case.  
...
# Bad
AllData # this looks too much like a Neuro-ID function
new_tibble_1 # this includes symbols
```

Function names should use large camel case.  
...
# Bad
createPlot # this looks too much like a variable
generate_report # this includes symbols
```
